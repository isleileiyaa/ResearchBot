...
class KnowledgeBaseService(object):
    ...
    def upload_by_pdf(self, pdf_file):
        """将传入的PDF文件，解析文本，向量化，存入向量数据库中"""
        ...
        try:
            ...
            if len(full_text) > config.max_split_char_number:
                knowledge_chunks = self.spliter.split_text(full_text)
            else:
